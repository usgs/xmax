...
/**
 * Abstract Class representing FFT's of real, single precision data. Concrete
 * classes are typically named RealFloatFFT_<i>method</i>, implement the FFT
 ...
 * RealFloatFFT for the details. Note, however, that each class's backtransform
