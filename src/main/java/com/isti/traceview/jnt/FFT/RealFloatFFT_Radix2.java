...
/** Computes  FFT's of real, single precision data where n is an integral power of 2.
  ...
  * <a name="transformlayout"></a>For RealFloatFFT_Radix2, the correspondence is as follows:
  * <table summary="">
...
public class RealFloatFFT_Radix2 extends RealFloatFFT {
	private static final Logger logger = Logger.getLogger(RealFloatFFT_Radix2.class);
	private int logn;
